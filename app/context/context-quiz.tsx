...
export type ContextQuizState = Omit<
  ContextQuizType,
  "setTab" | "setPassageFontSize" | "nextQuestion" | "reset" | "setPickOption"
>;

export const ContextQuizConsumer = React.createContext<
...
export const ContextQuizProvider = ({
  children,
}: {
  children: React.ReactElement | React.ReactElement[] | React.ReactNode;
}) => {
  const [stateQuiz, setStateQuiz] =
    React.useState<Partial<ContextQuizState>>(defaultState);
