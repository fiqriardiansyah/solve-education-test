...
export default function Question() {
  ...
  const { currentQuestion, nextQuestion, setPickOption, pickOption } =
      ...
      <CenteredBox>
        <Container maxWidth="md">
          <Stack spacing={7} alignItems="center" sx={{ width: "100%" }}>
            ...
            {pickOption &&
              pickOption === currentQuestion?.question_data.answer && (
                <CorrectFeedback onNextQuestion={onNextQuestion} />
              )}
            {pickOption &&
              pickOption !== currentQuestion?.question_data.answer && (
                <InCorrectFeedback onNextQuestion={onNextQuestion} />
              )}
          </Stack>
        </Container>
      </CenteredBox>
